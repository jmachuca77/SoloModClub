...
class ShotManager():
    ...
    def Start(self, api):
        ...
        logger.log("Shotmanager Modified for Pano")
            ...
            if event == btn_msg.Press:
                if button == btn_msg.ButtonA or button == btn_msg.ButtonB:
                    ...
                    if (mode == 13):
                        ...
                        shot = shots.APP_SHOT_PANO

                    # only allow entry into these shots if the app is attached
                    allowedShots = [shots.APP_SHOT_ORBIT, shots.APP_SHOT_CABLECAM, shots.APP_SHOT_MULTIPOINT, shots.APP_SHOT_PANO]
